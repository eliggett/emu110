// GENERATED by tools/make_lcd_cgrom.py -- do not edit.
//
...
static const unsigned char kU110Cgrom[96][8] = {
    ...
    { 0x0e, 0x11, 0x01, 0x06, 0x08, 0x10, 0x1f, 0x00 },  // 0x32  '2'
    ...
    { 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00 },  // 0x3A  ':'
    { 0x00, 0x00, 0x08, 0x00, 0x00, 0x08, 0x08, 0x10 },  // 0x3B  ';'
    { 0x00, 0x04, 0x08, 0x10, 0x08, 0x04, 0x00, 0x00 },  // 0x3C  '<'
    { 0x00, 0x00, 0x1f, 0x00, 0x1f, 0x00, 0x00, 0x00 },  // 0x3D  '='
    { 0x00, 0x10, 0x08, 0x04, 0x08, 0x10, 0x00, 0x00 },  // 0x3E  '>'
    ...
    { 0x0e, 0x11, 0x10, 0x13, 0x11, 0x11, 0x0f, 0x00 },  // 0x47  'G'
    ...
    { 0x10, 0x10, 0x16, 0x19, 0x11, 0x19, 0x16, 0x00 },  // 0x62  'b'
    { 0x00, 0x00, 0x0e, 0x11, 0x10, 0x11, 0x0e, 0x00 },  // 0x63  'c'
    { 0x01, 0x01, 0x0d, 0x13, 0x11, 0x13, 0x0d, 0x00 },  // 0x64  'd'
    { 0x00, 0x00, 0x0e, 0x11, 0x1f, 0x10, 0x0e, 0x00 },  // 0x65  'e'
    { 0x06, 0x09, 0x08, 0x1e, 0x08, 0x08, 0x08, 0x00 },  // 0x66  'f'
    { 0x00, 0x00, 0x0d, 0x13, 0x11, 0x13, 0x0d, 0x0f },  // 0x67  'g'
    { 0x10, 0x10, 0x16, 0x19, 0x11, 0x11, 0x11, 0x00 },  // 0x68  'h'
    { 0x08, 0x00, 0x18, 0x08, 0x08, 0x08, 0x1c, 0x00 },  // 0x69  'i'
    { 0x02, 0x00, 0x06, 0x02, 0x02, 0x02, 0x02, 0x1e },  // 0x6A  'j'
    { 0x10, 0x10, 0x11, 0x12, 0x1c, 0x12, 0x11, 0x00 },  // 0x6B  'k'
    { 0x18, 0x08, 0x08, 0x08, 0x08, 0x08, 0x1c, 0x00 },  // 0x6C  'l'
    { 0x00, 0x00, 0x1a, 0x15, 0x15, 0x15, 0x11, 0x00 },  // 0x6D  'm'
    { 0x00, 0x00, 0x16, 0x19, 0x11, 0x11, 0x11, 0x00 },  // 0x6E  'n'
    { 0x00, 0x00, 0x0e, 0x11, 0x11, 0x11, 0x0e, 0x00 },  // 0x6F  'o'
    { 0x00, 0x00, 0x16, 0x19, 0x11, 0x19, 0x16, 0x10 },  // 0x70  'p'
    { 0x00, 0x00, 0x0d, 0x13, 0x11, 0x13, 0x0d, 0x01 },  // 0x71  'q'
    { 0x00, 0x00, 0x16, 0x19, 0x10, 0x10, 0x10, 0x00 },  // 0x72  'r'
    { 0x00, 0x00, 0x0f, 0x10, 0x0e, 0x01, 0x1e, 0x00 },  // 0x73  's'
    { 0x08, 0x08, 0x1e, 0x08, 0x08, 0x09, 0x06, 0x00 },  // 0x74  't'
    { 0x00, 0x00, 0x11, 0x11, 0x11, 0x13, 0x0d, 0x00 },  // 0x75  'u'
    { 0x00, 0x00, 0x11, 0x11, 0x11, 0x0a, 0x04, 0x00 },  // 0x76  'v'
    { 0x00, 0x00, 0x11, 0x15, 0x15, 0x15, 0x0a, 0x00 },  // 0x77  'w'
    { 0x00, 0x00, 0x11, 0x0a, 0x04, 0x0a, 0x11, 0x00 },  // 0x78  'x'
    { 0x00, 0x00, 0x11, 0x11, 0x11, 0x13, 0x0d, 0x0f },  // 0x79  'y'
    { 0x00, 0x00, 0x1f, 0x02, 0x04, 0x08, 0x1f, 0x00 },  // 0x7A  'z'
    { 0x06, 0x08, 0x04, 0x18, 0x04, 0x08, 0x06, 0x00 },  // 0x7B  '{'
    { 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00 },  // 0x7C  '|'
    { 0x18, 0x04, 0x08, 0x06, 0x08, 0x04, 0x18, 0x00 },  // 0x7D  '}'
    { 0x00, 0x00, 0x09, 0x15, 0x12, 0x00, 0x00, 0x00 },  // 0x7E  '~'
